...
💡 <b>Совет:</b> Если хотите связать свой номер телефона с аккаунтом, отправьте команду <code>/phone</code> и поделитесь номером через кнопку ниже.

Нажмите кнопку для завершения регистрации и заполнения профиля:

...
✅ **Конструктор документов** с WYSIWYG редактором (TinyMCE)  
✅ Генерация заявлений в PDF через Puppeteer  
...
- **[SYSTEM_OVERVIEW.md](./docs/SYSTEM_OVERVIEW.md)** - Обзор системы и архитектуры
- **[DOCUMENT_TEMPLATES_GUIDE.md](./docs/DOCUMENT_TEMPLATES_GUIDE.md)** - Руководство по конструктору документов

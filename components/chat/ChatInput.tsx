...
function ChatInputComponent({
  ...
  return (
    <div 
      className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex-shrink-0 px-2 py-2 md:px-3 md:py-2"
    ...
    >
      ...
      <div className="flex items-end gap-2 w-full">
        ...
        <div className="relative flex-shrink-0 self-end mb-0.5" ref={attachMenuRef}>
          <button
            onClick={() => setShowAttachMenu(!showAttachMenu)}
            disabled={disabled}
            className={`w-9 h-9 rounded-full transition-colors disabled:opacity-50 flex items-center justify-center ${
              showAttachMenu 
        ...
        <div className="flex-1 min-w-0">
          <textarea
            ...
            disabled={disabled}
            rows={1}
            className="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-600 rounded-2xl bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:border-gray-300 dark:focus:border-gray-500 resize-none text-sm disabled:opacity-50"
        ...
        <button
          ...
          className="w-9 h-9 bg-blue-500 hover:bg-blue-600 text-white rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0 self-end mb-0.5 flex items-center justify-center"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

      ...
      <div className="flex items-end gap-2 w-full">
        ...
        <div className="flex-1 min-w-0 self-end">
          <textarea
            ...
            disabled={disabled}
            rows={1}
            className="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-2xl bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:border-gray-300 dark:focus:border-gray-500 resize-none text-sm disabled:opacity-50"

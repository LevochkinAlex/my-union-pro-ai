      ...
      <div className="flex items-center gap-2 w-full">
        ...
        <div className="relative flex-shrink-0" ref={attachMenuRef}>
          <button
            ...
            disabled={disabled}
            className={`w-10 h-10 rounded-full transition-colors disabled:opacity-50 flex items-center justify-center ${
              showAttachMenu 
        ...
        <div className="flex-1 min-w-0">
          <textarea
            ...
            disabled={disabled}
            rows={1}
            className="w-full h-10 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-full bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:border-gray-400 dark:focus:border-gray-500 resize-none text-sm disabled:opacity-50 leading-6"
          />
        </div>
        ...
        <button
          ...
          className="w-10 h-10 bg-blue-500 hover:bg-blue-600 text-white rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0 flex items-center justify-center"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

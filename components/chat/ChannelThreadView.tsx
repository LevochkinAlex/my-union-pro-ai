              ...
              {replyingTo === comment.id && (
                <div className="ml-11 space-y-2">
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm transition-colors"
                    rows={3}
                  />
                  <div className="flex items-center gap-2">

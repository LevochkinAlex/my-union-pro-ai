  ...
  return (
    <div className="space-y-2">
      ...
      <div
        ...
        className={`flex items-center gap-2 text-gray-700 dark:text-gray-300 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors ${
          isCollapsed ? "h-10 w-10 justify-center" : "px-4 py-2"
        }`}
        title={isCollapsed ? "AI Чат" : undefined}
      >
        ...
        <div className="space-y-1 border-l-2 border-gray-200 dark:border-gray-700 pl-2" ref={menuRef}>
          ...
          {sessions.find(s => s.type === "STATEMENT") && (
            ...
            >
              ...
              <span className="flex-1 truncate font-semibold">Заявление</span>

...
export default function UserCard({ user }: UserCardProps) {
  ...
  return (
    <div className="group bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all overflow-hidden">
      ...
      <div className="px-6 pb-6 pt-2 border-t border-gray-100 dark:border-gray-700/50">
        <button className="w-full py-2 px-4 rounded-lg border border-blue-600 text-blue-600 dark:border-blue-400 dark:text-blue-400 font-medium text-sm hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">
          Подключиться
        </button>
      </div>
    </div>

    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute bottom-full left-0 right-0 mb-1 z-20 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="py-1">

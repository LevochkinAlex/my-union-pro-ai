...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  const variantClasses = {
    success: {
      container: "bg-success-50 dark:bg-success-500/15 border-success-500 dark:border-success-500/30",
      icon: "text-success-500",
      text: "text-success-700 dark:text-success-300",
    },
    error: {
      container: "bg-error-50 dark:bg-error-500/15 border-error-500 dark:border-error-500/30",
      icon: "text-error-500",
      text: "text-error-700 dark:text-error-300",
    },
    warning: {
      container: "bg-warning-50 dark:bg-warning-500/15 border-warning-500 dark:border-warning-500/30",
      icon: "text-warning-500",
      text: "text-warning-700 dark:text-warning-300",
    },
    info: {
      container: "bg-blue-light-50 dark:bg-blue-light-500/15 border-blue-light-500 dark:border-blue-light-500/30",
        ...
        {toasts.map((toast) => (
          ...
          >
            ...
            <button
              ...
              className={`flex-shrink-0 ${variantClasses[toast.variant].text} hover:opacity-70 transition-opacity`}
            >

    ...
    switch (status) {
      ...
      case "excluded":
        return {
          ...
          description: "Вы были исключены из профсоюза. Для уточнения причин свяжитесь с председателем. Если вы сменили место работы и организацию — обновите профиль (новая ППО), после одобрения новым председателем перегенерируйте заявления в разделе «Документы».",
          buttonText: "На главную",
          buttonLink: "/dashboard",
        };
      default:

        ...
        <ModalFooter className="p-3 sm:p-4 md:p-6 pt-3 sm:pt-4 rounded-b-3xl">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-6 py-2.5 font-medium text-gray-700 hover-surface dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
            >
              {currentStep > 1 ? (
                <>
                  <X className="h-4 w-4" />

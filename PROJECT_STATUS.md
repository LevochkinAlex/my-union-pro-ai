...
**Последнее обновление:** Реализован AI чат для сбора данных профиля. Пользователи могут заполнить профиль через диалог с AI-помощником. Данные автоматически сохраняются в базу при завершении сбора.

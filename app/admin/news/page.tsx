                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-2">
                        <Link
                          ...
                          className="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover-surface dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600"
                        >
                          Редактировать
                        </Link>
                        <button

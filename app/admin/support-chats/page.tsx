...
export default function AdminSupportChatsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-14rem)] min-h-[420px]">
        {/* Список чатов — карточка как в админке */}
        <div className="w-full lg:w-96 flex-shrink-0 overflow-hidden rounded-lg border bg-card text-card-foreground shadow-sm flex flex-col">
        ...
        {/* Окно переписки — карточка и пузыри в стиле дизайн-системы */}
        <div className="flex-1 min-h-0 flex flex-col rounded-lg border bg-card text-card-foreground shadow-sm">
          {!selectedChatId ? (
            ...
            <>
              ...
              <div className="border-t p-3 flex gap-2 bg-muted/20">
                <input
                  ...
                  className="flex-1 rounded-lg border border-input bg-background px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:opacity-50"
                  disabled={sending}
                />
                <button
                  type="button"
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
                >

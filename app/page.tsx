...
export const metadata = {
  title: "MyUnion Pro — автоматизация профсоюзных организаций",
  description:
    "Платформа для автоматизации ППО: документооборот, члены профсоюза, обращения, ИИ-помощник. Дорожная карта, цены, контакты ООО ЯППИКС.",
};
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section className="relative min-h-[32rem] py-20 md:py-28">
          ...
          <div className="absolute inset-x-0 top-0 z-0 h-full min-h-0" aria-hidden style={{ bottom: "-240px" }}>
          ...
          <div
            className="absolute bottom-0 left-0 right-0 z-[1] h-24 w-full md:h-28"
            aria-hidden

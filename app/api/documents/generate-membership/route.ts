...
import { generateMembershipApplication } from "@/lib/documents";
...
export async function POST() {
  try {
    ...
    const filePath = await generateMembershipApplication(user, ppoChairman);
    ...
    console.error("[documents/generate-membership] Ошибка:", error);
    return NextResponse.json(

...
2. **СРАЗУ выведи структурированное резюме** в ТОЧНОМ формате:

"Отлично! Давайте проверим собранные данные:

1. **Регион**: [регион из истории]
2. **Организация**: [полное название организации из истории]
3. **ФИО**: [Фамилия] [Имя] [Отчество]
4. **Дата рождения**: [ДД.ММ.ГГГГ]
5. **Адрес**: [полный адрес]
6. **Телефон**: [номер телефона]
7. **Должность**: [должность из истории]
8. **Профессия**: [профессия из истории]
9. **Образование**: [уровень образования из истории]

...
6. **ДЕТИ**: Спроси: "Есть ли у вас дети? Расскажите о них"
   - **ВАЖНО**: Обязательно узнай имена и даты рождения (или хотя бы возраст) каждого ребенка - это нужно профсоюзу для подготовки подарков к праздникам
...
6. **ДЕТИ**: Спроси: "Есть ли у вас дети?"
   - Если да, уточни: "Расскажите о ваших детях: имена и даты рождения (или возраст)"
   - **ВАЖНО**: Обязательно узнай дату рождения или возраст каждого ребенка - это нужно для подарков к праздникам

  ...
  try {
    ...
    if (messages.length === 0) {
      ...
      if (chatSession.type === "STATEMENT") {
        welcomeMessageContent = `Здравствуйте! Я уникальный AI-бот профсоюза, готовый консультировать вас по всем сложным вопросам, связанным с профсоюзной деятельностью, вашими правами, льготами и преимуществами членства.

...
/**
 * POST /api/org-head/organizations/[id]/invite-chairman
 * Отправляет инвайт-ссылку председателю организации и создает учетную запись (РПО или SUPER_ADMIN)
 */
export async function POST(
  ...
  try {
    ...
    console.error("[org-head/organizations] POST invite-chairman error:", error);
    return NextResponse.json(
      {

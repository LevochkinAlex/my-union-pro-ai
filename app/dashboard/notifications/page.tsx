        ...
        actions={
          <>
            ...
            <button
              ...
              disabled={clearing}
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 sm:px-6 py-2 font-medium text-gray-700 hover-surface disabled:opacity-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 whitespace-nowrap"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {DOC_APPROVAL_TYPES.includes(notification.type) &&
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2" onClick={(e) => e.stopPropagation()}>
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 shadow-sm hover-surface dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200"
                      >
                        Посмотреть
                      </button>
                      <button
